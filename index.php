...
function loginForm() {
	...
	<strong><marquee behavior="scrollTop">WELCOME TO COMPUTER SCIENCE DEPARTMENT JIGPOLY Online Meeting Application</marquee></span></font></div></strong>

	</br></br><a href="../choose.php">Goto Home Page</a>
		<div id="loginform">
			<form action="index.php" method="post">
			<h1>Online Meeting Application</h1><hr/>
				<label for="name">Please Enter Your popular Name To chat with people</label>
				<input type="text" name="name" id="name" class="form-control" placeholder="Enter Your popular Name" value="'.$_SESSION['fullname'].'"/>
...
if (isset ( $_POST ['enter'] )) {
    if ($_POST ['name'] != "") {
        ...
        $cb = fopen ( "log.html", 'a' );
        fwrite ( $cb, "<div class='msgln'><i> " . $_SESSION ['name'] . " has joined the chat.</i><br></div>" );
        fclose ( $cb );
    } else {
...
<html>
<head>
	<title>Online Meeting Application </title>
